...
(fact "all-evens"
      (fp-oo.ex-01/all-evens) => []
      (fp-oo.ex-01/all-evens [2]) => [[2]]
      (fp-oo.ex-01/all-evens [2] [7 1]) => [[2]]
      (fp-oo.ex-01/all-evens [2] [7 1] [8 2 8]) => [[2] [8 2 8]]
      (fp-oo.ex-01/all-evens [2] [7 1] [8 2 8] [1 8]) => [[2] [8 2 8]]
      (fp-oo.ex-01/all-evens [1] [4 1] [4 2]) => [[4 2]])
